...
main_menu() {
  while true; do
    clear
    echo -e "${CYAN}"
    echo -e " ___ ____ ____ ____     ____ _  _ ____ _  _    _  _ ____ _  _ "
    echo -e "|_ _|  _ \ ___|  _ \   |  _ \ || | __ ) || |  | || | ___| || |"
    echo -e " | || |_) / _ \ | | |  | | | | || |  _ \ || |_ | || |___ \ || |_"
    echo -e " | ||  __/  __/ |_| |  | |_| |__   |_) |__   _||__   ___) |__   _|"
    echo -e "|___|_|   \___|____/   |____/|_||_|____/   |_|    |_|____/   |_|"
    echo -e "                         工 具 箱                              "
    echo -e "                                                              ${NC}"
    echo -e "${YELLOW}==================================================${NC}"
    echo -e "1. 开启root用户登录"

...
main_menu() {
  while true; do
    ...
    echo "3. 智能流量监控                        19. TCP性能优化"
    echo "4. 安装 Snell 协议服务                 20. 命令行美化"
    echo "5. 安装 Hysteria2 协议服务             21. DNS解锁服务"
    echo "6. 安装 SS-Rust 协议服务               22. 安装Sub-Store"
    echo "7. 安装 ShadowTLS                      23. 搭建TG图床"
    echo "8. 一键IPTables转发                    24. TCP性能优化 (BBR+fq)"
    echo "9. 一键GOST转发                        25. 恢复TCP原始配置"
    echo "10. 安装 3X-UI 管理面板                26. 安装Fail2Ban"
    echo "11. 流媒体解锁检测                     27. 安装 acme.sh"
    echo "12. Speedtest网络测速                  28. 安装 Gost v3"
    echo "13. BestTrace回程测试                  29. 修改主机名"
